      ...
      <div className="bg-white shadow rounded-lg overflow-hidden">
        <Link to={`/trips/${tripId}`} className="block">
          <div className="relative h-48 group">
            ...
            />
            {/* Gradient Overlay */}
            <div className="absolute inset-0 bg-gradient-to-r from-gray-900/70 to-transparent group-hover:from-gray-900/60 transition-colors duration-300"></div>
            ...
            <div className="relative h-full flex items-center px-4 sm:px-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-3xl font-bold text-white group-hover:text-gray-100 transition-colors duration-300">{trip.name}</h2>
                  <p className="text-lg text-gray-200 mt-1 group-hover:text-gray-100 transition-colors duration-300">Trip Expenses</p>
                </div>
              </div>
            </div>
          </div>
