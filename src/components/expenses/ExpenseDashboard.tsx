  ...
  return (
    <div className="space-y-6">
      ...
      <div className="sm:hidden">
        <div className="flex gap-2 overflow-x-auto pb-1" role="tablist" aria-label="Expense sections">
          {tabs.map(tab => (
            <button
              key={tab.id}
          ...
          <button
            ...
            className="shrink-0 px-3 py-2 bg-green-600 text-white rounded-md hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 text-sm flex items-center justify-center space-x-2"
          >
      ...
      <div className="mt-6">
        {activeTab === 'summary' && (
          <ExpenseSummary tripId={tripId} participants={participants} currentUser={currentUser} />
        )}
